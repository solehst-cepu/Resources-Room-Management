...
export const EmailNotificationLogsTab: React.FC = () => {
  const { units, requests, currentUser, showToast, sendOrderCompletionEmailReport } = useApp();
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-slate-100">
                {units.map((u) => {
                  ...
                  const effectiveEmail = u.email || `${u.code.toLowerCase()}@lazuardi.sch.id`;
